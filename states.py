...
class SubmitState(object):
    ...
    def doModal(self):
        ...
        ret = dialog.yesno('Submit?', '{0} episodes, {1} movies'.format(len(self.episodes), len(self.movies)),
                           '{0} musicVideos, {1} video files'.format(len(self.musicVideos), len(self.videoFiles)))
